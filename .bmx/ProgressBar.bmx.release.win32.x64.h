#ifndef MAXGUI_PROXYGADGETS_PROGRESSBAR_BMX_RELEASE_WIN32_X64_H
#define MAXGUI_PROXYGADGETS_PROGRESSBAR_BMX_RELEASE_WIN32_X64_H

#include <brl.mod/blitz.mod/.bmx/blitz.bmx.release.win32.x64.h>
#include <maxgui.mod/drivers.mod/.bmx/drivers.bmx.release.win32.x64.h>
int _bb_maxgui_proxygadgets_progressbar();
struct maxgui_proxygadgets_progressbar_TPbar_obj;
void _maxgui_proxygadgets_progressbar_TPbar_New(struct maxgui_proxygadgets_progressbar_TPbar_obj* o);
typedef BBINT (*maxgui_proxygadgets_progressbar_TPbar_SetFont_TTGuiFont_m)(struct maxgui_proxygadgets_progressbar_TPbar_obj*,struct maxgui_maxgui_guifont_TGuiFont_obj*);
BBINT _maxgui_proxygadgets_progressbar_TPbar_SetFont_TTGuiFont(struct maxgui_proxygadgets_progressbar_TPbar_obj*,struct maxgui_maxgui_guifont_TGuiFont_obj*);
typedef BBSTRING (*maxgui_proxygadgets_progressbar_TPbar_GetText_m)(struct maxgui_proxygadgets_progressbar_TPbar_obj*);
BBSTRING _maxgui_proxygadgets_progressbar_TPbar_GetText(struct maxgui_proxygadgets_progressbar_TPbar_obj*);
typedef BBINT (*maxgui_proxygadgets_progressbar_TPbar_CleanUp_m)(struct maxgui_proxygadgets_progressbar_TPbar_obj*);
BBINT _maxgui_proxygadgets_progressbar_TPbar_CleanUp(struct maxgui_proxygadgets_progressbar_TPbar_obj*);
typedef BBINT (*maxgui_proxygadgets_progressbar_TPbar_SetProp_i_m)(struct maxgui_proxygadgets_progressbar_TPbar_obj*,BBINT);
BBINT _maxgui_proxygadgets_progressbar_TPbar_SetProp_i(struct maxgui_proxygadgets_progressbar_TPbar_obj*,BBINT);
typedef BBINT (*maxgui_proxygadgets_progressbar_TPbar_SetRange_ii_m)(struct maxgui_proxygadgets_progressbar_TPbar_obj*,BBINT,BBINT);
BBINT _maxgui_proxygadgets_progressbar_TPbar_SetRange_ii(struct maxgui_proxygadgets_progressbar_TPbar_obj*,BBINT,BBINT);
typedef BBINT (*maxgui_proxygadgets_progressbar_TPbar_SetEnabled_i_m)(struct maxgui_proxygadgets_progressbar_TPbar_obj*,BBINT);
BBINT _maxgui_proxygadgets_progressbar_TPbar_SetEnabled_i(struct maxgui_proxygadgets_progressbar_TPbar_obj*,BBINT);
typedef BBINT (*maxgui_proxygadgets_progressbar_TPbar_SetShow_i_m)(struct maxgui_proxygadgets_progressbar_TPbar_obj*,BBINT);
BBINT _maxgui_proxygadgets_progressbar_TPbar_SetShow_i(struct maxgui_proxygadgets_progressbar_TPbar_obj*,BBINT);
typedef BBINT (*maxgui_proxygadgets_progressbar_TPbar_Class_m)(struct maxgui_proxygadgets_progressbar_TPbar_obj*);
BBINT _maxgui_proxygadgets_progressbar_TPbar_Class(struct maxgui_proxygadgets_progressbar_TPbar_obj*);
typedef BBINT (*maxgui_proxygadgets_progressbar_TPbar_SetValue_f_m)(struct maxgui_proxygadgets_progressbar_TPbar_obj*,BBFLOAT);
BBINT _maxgui_proxygadgets_progressbar_TPbar_SetValue_f(struct maxgui_proxygadgets_progressbar_TPbar_obj*,BBFLOAT);
typedef BBINT (*maxgui_proxygadgets_progressbar_TPbar_SetColor_iii_m)(struct maxgui_proxygadgets_progressbar_TPbar_obj*,BBINT,BBINT,BBINT);
BBINT _maxgui_proxygadgets_progressbar_TPbar_SetColor_iii(struct maxgui_proxygadgets_progressbar_TPbar_obj*,BBINT,BBINT,BBINT);
typedef BBINT (*maxgui_proxygadgets_progressbar_TPbar_SetTextColor_iii_m)(struct maxgui_proxygadgets_progressbar_TPbar_obj*,BBINT,BBINT,BBINT);
BBINT _maxgui_proxygadgets_progressbar_TPbar_SetTextColor_iii(struct maxgui_proxygadgets_progressbar_TPbar_obj*,BBINT,BBINT,BBINT);
typedef BBINT (*maxgui_proxygadgets_progressbar_TPbar_SetPixmap_TTPixmapi_m)(struct maxgui_proxygadgets_progressbar_TPbar_obj*,struct brl_pixmap_TPixmap_obj*,BBINT);
BBINT _maxgui_proxygadgets_progressbar_TPbar_SetPixmap_TTPixmapi(struct maxgui_proxygadgets_progressbar_TPbar_obj*,struct brl_pixmap_TPixmap_obj*,BBINT);
typedef struct maxgui_proxygadgets_progressbar_TPbar_obj* (*maxgui_proxygadgets_progressbar_TPbar_Create_TTPbar_iiiiTTGadgeti_f)(BBINT,BBINT,BBINT,BBINT,struct maxgui_maxgui_gadget_TGadget_obj*,BBINT);
struct maxgui_proxygadgets_progressbar_TPbar_obj* maxgui_proxygadgets_progressbar_TPbar_Create_TTPbar_iiiiTTGadgeti(BBINT,BBINT,BBINT,BBINT,struct maxgui_maxgui_gadget_TGadget_obj*,BBINT);
typedef BBOBJECT (*maxgui_proxygadgets_progressbar_TPbar_EventHook_TObject_iTObjectTObject_f)(BBINT,BBOBJECT,BBOBJECT);
BBOBJECT maxgui_proxygadgets_progressbar_TPbar_EventHook_TObject_iTObjectTObject(BBINT,BBOBJECT,BBOBJECT);
struct BBClass_maxgui_proxygadgets_progressbar_TPbar {
	...
	maxgui_proxygadgets_progressbar_TPbar_CleanUp_m m_CleanUp;
	...
	maxgui_proxygadgets_progressbar_TPbar_GetText_m m_GetText;
	maxgui_proxygadgets_progressbar_TPbar_SetFont_TTGuiFont_m m_SetFont_TTGuiFont;
	maxgui_proxygadgets_progressbar_TPbar_SetColor_iii_m m_SetColor_iii;
	maxgui_maxgui_gadget_TProxyGadget_RemoveColor_m m_RemoveColor;
	maxgui_maxgui_gadget_TProxyGadget_SetAlpha_f_m m_SetAlpha_f;
	maxgui_proxygadgets_progressbar_TPbar_SetTextColor_iii_m m_SetTextColor_iii;
	...
	maxgui_proxygadgets_progressbar_TPbar_SetPixmap_TTPixmapi_m m_SetPixmap_TTPixmapi;
	maxgui_maxgui_gadget_TProxyGadget_SetIconStrip_TTIconStrip_m m_SetIconStrip_TTIconStrip;
	maxgui_proxygadgets_progressbar_TPbar_SetShow_i_m m_SetShow_i;
	maxgui_proxygadgets_progressbar_TPbar_SetEnabled_i_m m_SetEnabled_i;
	...
	maxgui_proxygadgets_progressbar_TPbar_Class_m m_Class;
	...
	maxgui_proxygadgets_progressbar_TPbar_SetValue_f_m m_SetValue_f;
	maxgui_proxygadgets_progressbar_TPbar_SetRange_ii_m m_SetRange_ii;
	maxgui_proxygadgets_progressbar_TPbar_SetProp_i_m m_SetProp_i;
	...
	maxgui_proxygadgets_progressbar_TPbar_Create_TTPbar_iiiiTTGadgeti_f f_Create_TTPbar_iiiiTTGadgeti;
	maxgui_proxygadgets_progressbar_TPbar_EventHook_TObject_iTObjectTObject_f f_EventHook_TObject_iTObjectTObject;
};

struct maxgui_proxygadgets_progressbar_TPbar_obj {
	struct BBClass_maxgui_proxygadgets_progressbar_TPbar* clas;
	...
	struct brl_pixmap_TPixmap_obj* _maxgui_proxygadgets_progressbar_tpbar__void_pixmap;
	struct brl_pixmap_TPixmap_obj* _maxgui_proxygadgets_progressbar_tpbar__green_pixmap;
	struct brl_pixmap_TPixmap_obj* _maxgui_proxygadgets_progressbar_tpbar__red_pixmap;
	struct brl_pixmap_TPixmap_obj* _maxgui_proxygadgets_progressbar_tpbar__yellow_pixmap;
	struct brl_pixmap_TPixmap_obj* _maxgui_proxygadgets_progressbar_tpbar_pixmap;
	struct brl_pixmap_TPixmap_obj* _maxgui_proxygadgets_progressbar_tpbar__star_pixmap;
	BBINT _maxgui_proxygadgets_progressbar_tpbar_pixmap_flags;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_progressbar_tpbar_panel;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_progressbar_tpbar_panel_value;
	BBARRAY _maxgui_proxygadgets_progressbar_tpbar_panels;
	BBARRAY _maxgui_proxygadgets_progressbar_tpbar_labels;
	BBARRAY _maxgui_proxygadgets_progressbar_tpbar_tcolor;
	BBINT _maxgui_proxygadgets_progressbar_tpbar_w;
	BBINT _maxgui_proxygadgets_progressbar_tpbar_h;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_progressbar_tpbar__label_p;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_progressbar_tpbar__label_v;
	BBFLOAT _maxgui_proxygadgets_progressbar_tpbar__value;
	BBINT _maxgui_proxygadgets_progressbar_tpbar__value_warning;
	BBINT _maxgui_proxygadgets_progressbar_tpbar__value_critical;
	BBINT _maxgui_proxygadgets_progressbar_tpbar_style;
	BBINT _maxgui_proxygadgets_progressbar_tpbar_flags;
};
extern struct BBClass_maxgui_proxygadgets_progressbar_TPbar maxgui_proxygadgets_progressbar_TPbar;
