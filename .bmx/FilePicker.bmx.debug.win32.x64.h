#ifndef MAXGUI_PROXYGADGETS_FILEPICKER_BMX_DEBUG_WIN32_X64_H
#define MAXGUI_PROXYGADGETS_FILEPICKER_BMX_DEBUG_WIN32_X64_H
...
struct maxgui_proxygadgets_filepicker_tFilepicker_obj;
void _maxgui_proxygadgets_filepicker_tFilepicker_New(struct maxgui_proxygadgets_filepicker_tFilepicker_obj* o);
typedef BBINT (*maxgui_proxygadgets_filepicker_tFilepicker_SetFont_TTGuiFont_m)(struct maxgui_proxygadgets_filepicker_tFilepicker_obj*,struct maxgui_maxgui_guifont_TGuiFont_obj*);
BBINT _maxgui_proxygadgets_filepicker_tFilepicker_SetFont_TTGuiFont(struct maxgui_proxygadgets_filepicker_tFilepicker_obj*,struct maxgui_maxgui_guifont_TGuiFont_obj*);
typedef BBINT (*maxgui_proxygadgets_filepicker_tFilepicker_SetPixmap_TTPixmapi_m)(struct maxgui_proxygadgets_filepicker_tFilepicker_obj*,struct brl_pixmap_TPixmap_obj*,BBINT);
BBINT _maxgui_proxygadgets_filepicker_tFilepicker_SetPixmap_TTPixmapi(struct maxgui_proxygadgets_filepicker_tFilepicker_obj*,struct brl_pixmap_TPixmap_obj*,BBINT);
typedef BBINT (*maxgui_proxygadgets_filepicker_tFilepicker_SelectFilter_S_m)(struct maxgui_proxygadgets_filepicker_tFilepicker_obj*,BBSTRING);
BBINT _maxgui_proxygadgets_filepicker_tFilepicker_SelectFilter_S(struct maxgui_proxygadgets_filepicker_tFilepicker_obj*,BBSTRING);
typedef BBINT (*maxgui_proxygadgets_filepicker_tFilepicker_Class_m)(struct maxgui_proxygadgets_filepicker_tFilepicker_obj*);
BBINT _maxgui_proxygadgets_filepicker_tFilepicker_Class(struct maxgui_proxygadgets_filepicker_tFilepicker_obj*);
typedef BBINT (*maxgui_proxygadgets_filepicker_tFilepicker_CleanUp_m)(struct maxgui_proxygadgets_filepicker_tFilepicker_obj*);
BBINT _maxgui_proxygadgets_filepicker_tFilepicker_CleanUp(struct maxgui_proxygadgets_filepicker_tFilepicker_obj*);
typedef BBINT (*maxgui_proxygadgets_filepicker_tFilepicker_SetShow_i_m)(struct maxgui_proxygadgets_filepicker_tFilepicker_obj*,BBINT);
BBINT _maxgui_proxygadgets_filepicker_tFilepicker_SetShow_i(struct maxgui_proxygadgets_filepicker_tFilepicker_obj*,BBINT);
typedef BBINT (*maxgui_proxygadgets_filepicker_tFilepicker_SetEnabled_i_m)(struct maxgui_proxygadgets_filepicker_tFilepicker_obj*,BBINT);
BBINT _maxgui_proxygadgets_filepicker_tFilepicker_SetEnabled_i(struct maxgui_proxygadgets_filepicker_tFilepicker_obj*,BBINT);
typedef struct maxgui_proxygadgets_filepicker_tFilepicker_obj* (*maxgui_proxygadgets_filepicker_tFilepicker_Create_TtFilepicker_SSiiiiTTGadgeti_f)(BBSTRING,BBSTRING,BBINT,BBINT,BBINT,BBINT,struct maxgui_maxgui_gadget_TGadget_obj*,BBINT);
struct maxgui_proxygadgets_filepicker_tFilepicker_obj* maxgui_proxygadgets_filepicker_tFilepicker_Create_TtFilepicker_SSiiiiTTGadgeti(BBSTRING,BBSTRING,BBINT,BBINT,BBINT,BBINT,struct maxgui_maxgui_gadget_TGadget_obj*,BBINT);
typedef BBINT (*maxgui_proxygadgets_filepicker_tFilepicker_SetColor_iii_m)(struct maxgui_proxygadgets_filepicker_tFilepicker_obj*,BBINT,BBINT,BBINT);
BBINT _maxgui_proxygadgets_filepicker_tFilepicker_SetColor_iii(struct maxgui_proxygadgets_filepicker_tFilepicker_obj*,BBINT,BBINT,BBINT);
typedef BBSTRING (*maxgui_proxygadgets_filepicker_tFilepicker_GetText_m)(struct maxgui_proxygadgets_filepicker_tFilepicker_obj*);
BBSTRING _maxgui_proxygadgets_filepicker_tFilepicker_GetText(struct maxgui_proxygadgets_filepicker_tFilepicker_obj*);
typedef BBINT (*maxgui_proxygadgets_filepicker_tFilepicker_SetText_S_m)(struct maxgui_proxygadgets_filepicker_tFilepicker_obj*,BBSTRING);
BBINT _maxgui_proxygadgets_filepicker_tFilepicker_SetText_S(struct maxgui_proxygadgets_filepicker_tFilepicker_obj*,BBSTRING);
typedef BBINT (*maxgui_proxygadgets_filepicker_tFilepicker_SetLayout_iiii_m)(struct maxgui_proxygadgets_filepicker_tFilepicker_obj*,BBINT,BBINT,BBINT,BBINT);
BBINT _maxgui_proxygadgets_filepicker_tFilepicker_SetLayout_iiii(struct maxgui_proxygadgets_filepicker_tFilepicker_obj*,BBINT,BBINT,BBINT,BBINT);
typedef BBOBJECT (*maxgui_proxygadgets_filepicker_tFilepicker_eventHandler_TObject_iTObjectTObject_f)(BBINT,BBOBJECT,BBOBJECT);
BBOBJECT maxgui_proxygadgets_filepicker_tFilepicker_eventHandler_TObject_iTObjectTObject(BBINT,BBOBJECT,BBOBJECT);
struct BBClass_maxgui_proxygadgets_filepicker_tFilepicker {
	...
	maxgui_proxygadgets_filepicker_tFilepicker_SetLayout_iiii_m m_SetLayout_iiii;
	...
	maxgui_proxygadgets_filepicker_tFilepicker_CleanUp_m m_CleanUp;
	...
	maxgui_proxygadgets_filepicker_tFilepicker_SetText_S_m m_SetText_S;
	maxgui_proxygadgets_filepicker_tFilepicker_GetText_m m_GetText;
	maxgui_proxygadgets_filepicker_tFilepicker_SetFont_TTGuiFont_m m_SetFont_TTGuiFont;
	maxgui_proxygadgets_filepicker_tFilepicker_SetColor_iii_m m_SetColor_iii;
	...
	maxgui_proxygadgets_filepicker_tFilepicker_SetPixmap_TTPixmapi_m m_SetPixmap_TTPixmapi;
	maxgui_maxgui_gadget_TProxyGadget_SetIconStrip_TTIconStrip_m m_SetIconStrip_TTIconStrip;
	maxgui_proxygadgets_filepicker_tFilepicker_SetShow_i_m m_SetShow_i;
	maxgui_proxygadgets_filepicker_tFilepicker_SetEnabled_i_m m_SetEnabled_i;
	...
	maxgui_proxygadgets_filepicker_tFilepicker_Class_m m_Class;
	...
	maxgui_proxygadgets_filepicker_tFilepicker_SelectFilter_S_m m_SelectFilter_S;
	maxgui_proxygadgets_filepicker_tFilepicker_Create_TtFilepicker_SSiiiiTTGadgeti_f f_Create_TtFilepicker_SSiiiiTTGadgeti;
	maxgui_proxygadgets_filepicker_tFilepicker_eventHandler_TObject_iTObjectTObject_f f_eventHandler_TObject_iTObjectTObject;
};

struct maxgui_proxygadgets_filepicker_tFilepicker_obj {
	struct BBClass_maxgui_proxygadgets_filepicker_tFilepicker* clas;
	...
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_filepicker_tfilepicker_panel;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_filepicker_tfilepicker_label;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_filepicker_tfilepicker_button;
	BBSTRING _maxgui_proxygadgets_filepicker_tfilepicker_path;
	BBSTRING _maxgui_proxygadgets_filepicker_tfilepicker_start_path;
	BBSTRING _maxgui_proxygadgets_filepicker_tfilepicker_message;
	BBINT _maxgui_proxygadgets_filepicker_tfilepicker_style;
	BBSTRING _maxgui_proxygadgets_filepicker_tfilepicker_extensions;
	struct brl_pixmap_TPixmap_obj* _maxgui_proxygadgets_filepicker_tfilepicker_pixmap;
	struct brl_pixmap_TPixmap_obj* _maxgui_proxygadgets_filepicker_tfilepicker_grey_pixmap;
};
extern struct BBClass_maxgui_proxygadgets_filepicker_tFilepicker maxgui_proxygadgets_filepicker_tFilepicker;
