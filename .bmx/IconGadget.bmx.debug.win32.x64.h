#ifndef MAXGUI_PROXYGADGETS_ICONGADGET_BMX_DEBUG_WIN32_X64_H
#define MAXGUI_PROXYGADGETS_ICONGADGET_BMX_DEBUG_WIN32_X64_H
...
struct maxgui_proxygadgets_icongadget_TIconGadget_obj;
void _maxgui_proxygadgets_icongadget_TIconGadget_New(struct maxgui_proxygadgets_icongadget_TIconGadget_obj* o);
typedef struct maxgui_proxygadgets_icongadget_TIconGadget_obj* (*maxgui_proxygadgets_icongadget_TIconGadget_Create_TTIconGadget_iiiiTTGadgetTObjecti_f)(BBINT,BBINT,BBINT,BBINT,struct maxgui_maxgui_gadget_TGadget_obj*,BBOBJECT,BBINT);
struct maxgui_proxygadgets_icongadget_TIconGadget_obj* maxgui_proxygadgets_icongadget_TIconGadget_Create_TTIconGadget_iiiiTTGadgetTObjecti(BBINT,BBINT,BBINT,BBINT,struct maxgui_maxgui_gadget_TGadget_obj*,BBOBJECT,BBINT);
typedef BBINT (*maxgui_proxygadgets_icongadget_TIconGadget_Class_m)(struct maxgui_proxygadgets_icongadget_TIconGadget_obj*);
BBINT _maxgui_proxygadgets_icongadget_TIconGadget_Class(struct maxgui_proxygadgets_icongadget_TIconGadget_obj*);
typedef BBSTRING (*maxgui_proxygadgets_icongadget_TIconGadget_GetText_m)(struct maxgui_proxygadgets_icongadget_TIconGadget_obj*);
BBSTRING _maxgui_proxygadgets_icongadget_TIconGadget_GetText(struct maxgui_proxygadgets_icongadget_TIconGadget_obj*);
typedef BBINT (*maxgui_proxygadgets_icongadget_TIconGadget_SetIconStrip_TTIconStrip_m)(struct maxgui_proxygadgets_icongadget_TIconGadget_obj*,struct maxgui_maxgui_iconstrip_TIconStrip_obj*);
BBINT _maxgui_proxygadgets_icongadget_TIconGadget_SetIconStrip_TTIconStrip(struct maxgui_proxygadgets_icongadget_TIconGadget_obj*,struct maxgui_maxgui_iconstrip_TIconStrip_obj*);
typedef BBINT (*maxgui_proxygadgets_icongadget_TIconGadget_SetPixmap_TTPixmapi_m)(struct maxgui_proxygadgets_icongadget_TIconGadget_obj*,struct brl_pixmap_TPixmap_obj*,BBINT);
BBINT _maxgui_proxygadgets_icongadget_TIconGadget_SetPixmap_TTPixmapi(struct maxgui_proxygadgets_icongadget_TIconGadget_obj*,struct brl_pixmap_TPixmap_obj*,BBINT);
typedef BBINT (*maxgui_proxygadgets_icongadget_TIconGadget_SelectItem_ii_m)(struct maxgui_proxygadgets_icongadget_TIconGadget_obj*,BBINT,BBINT);
BBINT _maxgui_proxygadgets_icongadget_TIconGadget_SelectItem_ii(struct maxgui_proxygadgets_icongadget_TIconGadget_obj*,BBINT,BBINT);
typedef BBINT (*maxgui_proxygadgets_icongadget_TIconGadget_SetItem_iSSiTObjecti_m)(struct maxgui_proxygadgets_icongadget_TIconGadget_obj*,BBINT,BBSTRING,BBSTRING,BBINT,BBOBJECT,BBINT);
BBINT _maxgui_proxygadgets_icongadget_TIconGadget_SetItem_iSSiTObjecti(struct maxgui_proxygadgets_icongadget_TIconGadget_obj*,BBINT,BBSTRING,BBSTRING,BBINT,BBOBJECT,BBINT);
typedef BBINT (*maxgui_proxygadgets_icongadget_TIconGadget_SetEnabled_i_m)(struct maxgui_proxygadgets_icongadget_TIconGadget_obj*,BBINT);
BBINT _maxgui_proxygadgets_icongadget_TIconGadget_SetEnabled_i(struct maxgui_proxygadgets_icongadget_TIconGadget_obj*,BBINT);
typedef BBINT (*maxgui_proxygadgets_icongadget_TIconGadget_CleanUp_m)(struct maxgui_proxygadgets_icongadget_TIconGadget_obj*);
BBINT _maxgui_proxygadgets_icongadget_TIconGadget_CleanUp(struct maxgui_proxygadgets_icongadget_TIconGadget_obj*);
typedef BBOBJECT (*maxgui_proxygadgets_icongadget_TIconGadget_eventHandler_TObject_iTObjectTObject_f)(BBINT,BBOBJECT,BBOBJECT);
BBOBJECT maxgui_proxygadgets_icongadget_TIconGadget_eventHandler_TObject_iTObjectTObject(BBINT,BBOBJECT,BBOBJECT);
typedef BBINT (*maxgui_proxygadgets_icongadget_TIconGadget_State_m)(struct maxgui_proxygadgets_icongadget_TIconGadget_obj*);
BBINT _maxgui_proxygadgets_icongadget_TIconGadget_State(struct maxgui_proxygadgets_icongadget_TIconGadget_obj*);
typedef BBINT (*maxgui_proxygadgets_icongadget_TIconGadget_SetShow_i_m)(struct maxgui_proxygadgets_icongadget_TIconGadget_obj*,BBINT);
BBINT _maxgui_proxygadgets_icongadget_TIconGadget_SetShow_i(struct maxgui_proxygadgets_icongadget_TIconGadget_obj*,BBINT);
struct BBClass_maxgui_proxygadgets_icongadget_TIconGadget {
	...
	maxgui_proxygadgets_icongadget_TIconGadget_SetItem_iSSiTObjecti_m m_SetItem_iSSiTObjecti;
	...
	maxgui_proxygadgets_icongadget_TIconGadget_SelectItem_ii_m m_SelectItem_ii;
	...
	maxgui_proxygadgets_icongadget_TIconGadget_CleanUp_m m_CleanUp;
	...
	maxgui_proxygadgets_icongadget_TIconGadget_State_m m_State;
	maxgui_maxgui_gadget_TProxyGadget_SetText_S_m m_SetText_S;
	maxgui_proxygadgets_icongadget_TIconGadget_GetText_m m_GetText;
	...
	maxgui_proxygadgets_icongadget_TIconGadget_SetPixmap_TTPixmapi_m m_SetPixmap_TTPixmapi;
	maxgui_proxygadgets_icongadget_TIconGadget_SetIconStrip_TTIconStrip_m m_SetIconStrip_TTIconStrip;
	maxgui_proxygadgets_icongadget_TIconGadget_SetShow_i_m m_SetShow_i;
	maxgui_proxygadgets_icongadget_TIconGadget_SetEnabled_i_m m_SetEnabled_i;
	...
	maxgui_proxygadgets_icongadget_TIconGadget_Class_m m_Class;
	...
	maxgui_proxygadgets_icongadget_TIconGadget_Create_TTIconGadget_iiiiTTGadgetTObjecti_f f_Create_TTIconGadget_iiiiTTGadgetTObjecti;
	maxgui_proxygadgets_icongadget_TIconGadget_eventHandler_TObject_iTObjectTObject_f f_eventHandler_TObject_iTObjectTObject;
};

struct maxgui_proxygadgets_icongadget_TIconGadget_obj {
	struct BBClass_maxgui_proxygadgets_icongadget_TIconGadget* clas;
	...
	BBINT _maxgui_proxygadgets_icongadget_ticongadget_style;
	BBINT _maxgui_proxygadgets_icongadget_ticongadget_animated;
	BBINT _maxgui_proxygadgets_icongadget_ticongadget_original_animated;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_icongadget_ticongadget_panel;
	BBSTRING _maxgui_proxygadgets_icongadget_ticongadget_name;
	struct maxgui_maxgui_iconstrip_TIconStrip_obj* _maxgui_proxygadgets_icongadget_ticongadget_iconstrip;
	struct maxgui_maxgui_iconstrip_TIconStrip_obj* _maxgui_proxygadgets_icongadget_ticongadget_grey_iconstrip;
	struct maxgui_maxgui_iconstrip_TIconStrip_obj* _maxgui_proxygadgets_icongadget_ticongadget_o_iconstrip;
	struct brl_pixmap_TPixmap_obj* _maxgui_proxygadgets_icongadget_ticongadget_pixmap;
	struct brl_pixmap_TPixmap_obj* _maxgui_proxygadgets_icongadget_ticongadget_grey_pixmap;
	struct brl_pixmap_TPixmap_obj* _maxgui_proxygadgets_icongadget_ticongadget_o_pixmap;
	BBINT _maxgui_proxygadgets_icongadget_ticongadget_frame_max;
	BBINT _maxgui_proxygadgets_icongadget_ticongadget_frame_current;
	BBINT _maxgui_proxygadgets_icongadget_ticongadget_frame_timer;
	BBINT _maxgui_proxygadgets_icongadget_ticongadget_frame_duration;
	BBINT _maxgui_proxygadgets_icongadget_ticongadget_frame_start;
	BBINT _maxgui_proxygadgets_icongadget_ticongadget_frame_direction;
};
extern struct BBClass_maxgui_proxygadgets_icongadget_TIconGadget maxgui_proxygadgets_icongadget_TIconGadget;
extern struct brl_timer_TTimer_obj* maxgui_proxygadgets_icongadget_TIconGadget_icon_timer;
