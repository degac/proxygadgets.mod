#ifndef MAXGUI_PROXYGADGETS_DATEPICKER_BMX_DEBUG_WIN32_X64_H
#define MAXGUI_PROXYGADGETS_DATEPICKER_BMX_DEBUG_WIN32_X64_H

#include <brl.mod/blitz.mod/.bmx/blitz.bmx.debug.win32.x64.h>
#include <maxgui.mod/maxgui.mod/.bmx/maxgui.bmx.debug.win32.x64.h>
#include "Calendar.bmx.debug.win32.x64.h"
#include "common.bmx.debug.win32.x64.h"
int _bb_maxgui_proxygadgets_datepicker();
struct maxgui_proxygadgets_datepicker_tdatepicker_obj;
void _maxgui_proxygadgets_datepicker_tdatepicker_New(struct maxgui_proxygadgets_datepicker_tdatepicker_obj* o);
typedef BBINT (*maxgui_proxygadgets_datepicker_tdatepicker_SetFont_TTGuiFont_m)(struct maxgui_proxygadgets_datepicker_tdatepicker_obj*,struct maxgui_maxgui_guifont_TGuiFont_obj*);
BBINT _maxgui_proxygadgets_datepicker_tdatepicker_SetFont_TTGuiFont(struct maxgui_proxygadgets_datepicker_tdatepicker_obj*,struct maxgui_maxgui_guifont_TGuiFont_obj*);
typedef BBINT (*maxgui_proxygadgets_datepicker_tdatepicker_CleanUp_m)(struct maxgui_proxygadgets_datepicker_tdatepicker_obj*);
BBINT _maxgui_proxygadgets_datepicker_tdatepicker_CleanUp(struct maxgui_proxygadgets_datepicker_tdatepicker_obj*);
typedef BBINT (*maxgui_proxygadgets_datepicker_tdatepicker_SetShow_i_m)(struct maxgui_proxygadgets_datepicker_tdatepicker_obj*,BBINT);
BBINT _maxgui_proxygadgets_datepicker_tdatepicker_SetShow_i(struct maxgui_proxygadgets_datepicker_tdatepicker_obj*,BBINT);
typedef BBINT (*maxgui_proxygadgets_datepicker_tdatepicker_SetText_S_m)(struct maxgui_proxygadgets_datepicker_tdatepicker_obj*,BBSTRING);
BBINT _maxgui_proxygadgets_datepicker_tdatepicker_SetText_S(struct maxgui_proxygadgets_datepicker_tdatepicker_obj*,BBSTRING);
typedef BBINT (*maxgui_proxygadgets_datepicker_tdatepicker_SetEnabled_i_m)(struct maxgui_proxygadgets_datepicker_tdatepicker_obj*,BBINT);
BBINT _maxgui_proxygadgets_datepicker_tdatepicker_SetEnabled_i(struct maxgui_proxygadgets_datepicker_tdatepicker_obj*,BBINT);
typedef BBSTRING (*maxgui_proxygadgets_datepicker_tdatepicker_GetText_m)(struct maxgui_proxygadgets_datepicker_tdatepicker_obj*);
BBSTRING _maxgui_proxygadgets_datepicker_tdatepicker_GetText(struct maxgui_proxygadgets_datepicker_tdatepicker_obj*);
typedef BBINT (*maxgui_proxygadgets_datepicker_tdatepicker_Class_m)(struct maxgui_proxygadgets_datepicker_tdatepicker_obj*);
BBINT _maxgui_proxygadgets_datepicker_tdatepicker_Class(struct maxgui_proxygadgets_datepicker_tdatepicker_obj*);
typedef BBINT (*maxgui_proxygadgets_datepicker_tdatepicker_SetPixmap_TTPixmapi_m)(struct maxgui_proxygadgets_datepicker_tdatepicker_obj*,struct brl_pixmap_TPixmap_obj*,BBINT);
BBINT _maxgui_proxygadgets_datepicker_tdatepicker_SetPixmap_TTPixmapi(struct maxgui_proxygadgets_datepicker_tdatepicker_obj*,struct brl_pixmap_TPixmap_obj*,BBINT);
typedef BBINT (*maxgui_proxygadgets_datepicker_tdatepicker_SetColor_iii_m)(struct maxgui_proxygadgets_datepicker_tdatepicker_obj*,BBINT,BBINT,BBINT);
BBINT _maxgui_proxygadgets_datepicker_tdatepicker_SetColor_iii(struct maxgui_proxygadgets_datepicker_tdatepicker_obj*,BBINT,BBINT,BBINT);
typedef struct maxgui_proxygadgets_datepicker_tdatepicker_obj* (*maxgui_proxygadgets_datepicker_tdatepicker_Create_Ttdatepicker_iiiiTTGadget_f)(BBINT,BBINT,BBINT,BBINT,struct maxgui_maxgui_gadget_TGadget_obj*);
struct maxgui_proxygadgets_datepicker_tdatepicker_obj* maxgui_proxygadgets_datepicker_tdatepicker_Create_Ttdatepicker_iiiiTTGadget(BBINT,BBINT,BBINT,BBINT,struct maxgui_maxgui_gadget_TGadget_obj*);
typedef BBOBJECT (*maxgui_proxygadgets_datepicker_tdatepicker_eventHandler_TObject_iTObjectTObject_f)(BBINT,BBOBJECT,BBOBJECT);
BBOBJECT maxgui_proxygadgets_datepicker_tdatepicker_eventHandler_TObject_iTObjectTObject(BBINT,BBOBJECT,BBOBJECT);
struct BBClass_maxgui_proxygadgets_datepicker_tdatepicker {
	...
	maxgui_proxygadgets_datepicker_tdatepicker_CleanUp_m m_CleanUp;
	...
	maxgui_proxygadgets_datepicker_tdatepicker_SetText_S_m m_SetText_S;
	maxgui_proxygadgets_datepicker_tdatepicker_GetText_m m_GetText;
	maxgui_proxygadgets_datepicker_tdatepicker_SetFont_TTGuiFont_m m_SetFont_TTGuiFont;
	maxgui_proxygadgets_datepicker_tdatepicker_SetColor_iii_m m_SetColor_iii;
	...
	maxgui_proxygadgets_datepicker_tdatepicker_SetPixmap_TTPixmapi_m m_SetPixmap_TTPixmapi;
	maxgui_maxgui_gadget_TProxyGadget_SetIconStrip_TTIconStrip_m m_SetIconStrip_TTIconStrip;
	maxgui_proxygadgets_datepicker_tdatepicker_SetShow_i_m m_SetShow_i;
	maxgui_proxygadgets_datepicker_tdatepicker_SetEnabled_i_m m_SetEnabled_i;
	...
	maxgui_proxygadgets_datepicker_tdatepicker_Class_m m_Class;
	...
	maxgui_proxygadgets_datepicker_tdatepicker_Create_Ttdatepicker_iiiiTTGadget_f f_Create_Ttdatepicker_iiiiTTGadget;
	maxgui_proxygadgets_datepicker_tdatepicker_eventHandler_TObject_iTObjectTObject_f f_eventHandler_TObject_iTObjectTObject;
};

struct maxgui_proxygadgets_datepicker_tdatepicker_obj {
	struct BBClass_maxgui_proxygadgets_datepicker_tdatepicker* clas;
	...
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_datepicker_tdatepicker_panel;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_datepicker_tdatepicker_panel2;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_datepicker_tdatepicker_label;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_datepicker_tdatepicker_button;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_datepicker_tdatepicker_window;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_datepicker_tdatepicker_superparent;
	BBINT _maxgui_proxygadgets_datepicker_tdatepicker_style;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_datepicker_tdatepicker_calendar;
	BBINT _maxgui_proxygadgets_datepicker_tdatepicker_active;
	BBINT _maxgui_proxygadgets_datepicker_tdatepicker_x;
	BBINT _maxgui_proxygadgets_datepicker_tdatepicker_y;
	BBINT _maxgui_proxygadgets_datepicker_tdatepicker_h;
	struct brl_pixmap_TPixmap_obj* _maxgui_proxygadgets_datepicker_tdatepicker_pixmap;
	struct brl_pixmap_TPixmap_obj* _maxgui_proxygadgets_datepicker_tdatepicker_grey_pixmap;
	BBSTRING _maxgui_proxygadgets_datepicker_tdatepicker_format;
};
extern struct BBClass_maxgui_proxygadgets_datepicker_tdatepicker maxgui_proxygadgets_datepicker_tdatepicker;
