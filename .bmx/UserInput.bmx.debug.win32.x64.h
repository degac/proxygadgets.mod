#ifndef MAXGUI_PROXYGADGETS_USERINPUT_BMX_DEBUG_WIN32_X64_H
#define MAXGUI_PROXYGADGETS_USERINPUT_BMX_DEBUG_WIN32_X64_H
...
typedef BBINT (*maxgui_proxygadgets_userinput_tUserInput_Class_m)(struct maxgui_proxygadgets_userinput_tUserInput_obj*);
BBINT _maxgui_proxygadgets_userinput_tUserInput_Class(struct maxgui_proxygadgets_userinput_tUserInput_obj*);
typedef BBINT (*maxgui_proxygadgets_userinput_tUserInput_SetFont_TTGuiFont_m)(struct maxgui_proxygadgets_userinput_tUserInput_obj*,struct maxgui_maxgui_guifont_TGuiFont_obj*);
BBINT _maxgui_proxygadgets_userinput_tUserInput_SetFont_TTGuiFont(struct maxgui_proxygadgets_userinput_tUserInput_obj*,struct maxgui_maxgui_guifont_TGuiFont_obj*);
typedef BBINT (*maxgui_proxygadgets_userinput_tUserInput_CleanUp_m)(struct maxgui_proxygadgets_userinput_tUserInput_obj*);
BBINT _maxgui_proxygadgets_userinput_tUserInput_CleanUp(struct maxgui_proxygadgets_userinput_tUserInput_obj*);
typedef BBINT (*maxgui_proxygadgets_userinput_tUserInput_SetText_S_m)(struct maxgui_proxygadgets_userinput_tUserInput_obj*,BBSTRING);
BBINT _maxgui_proxygadgets_userinput_tUserInput_SetText_S(struct maxgui_proxygadgets_userinput_tUserInput_obj*,BBSTRING);
typedef struct maxgui_proxygadgets_userinput_tUserInput_obj* (*maxgui_proxygadgets_userinput_tUserInput_Create_TtUserInput_SSiiTTGadgetaS_f)(BBSTRING,BBSTRING,BBINT,BBINT,struct maxgui_maxgui_gadget_TGadget_obj*,BBARRAY);
struct maxgui_proxygadgets_userinput_tUserInput_obj* maxgui_proxygadgets_userinput_tUserInput_Create_TtUserInput_SSiiTTGadgetaS(BBSTRING,BBSTRING,BBINT,BBINT,struct maxgui_maxgui_gadget_TGadget_obj*,BBARRAY);
typedef BBINT (*maxgui_proxygadgets_userinput_tUserInput_SetColor_iii_m)(struct maxgui_proxygadgets_userinput_tUserInput_obj*,BBINT,BBINT,BBINT);
BBINT _maxgui_proxygadgets_userinput_tUserInput_SetColor_iii(struct maxgui_proxygadgets_userinput_tUserInput_obj*,BBINT,BBINT,BBINT);
typedef BBINT (*maxgui_proxygadgets_userinput_tUserInput_SetEnabled_i_m)(struct maxgui_proxygadgets_userinput_tUserInput_obj*,BBINT);
BBINT _maxgui_proxygadgets_userinput_tUserInput_SetEnabled_i(struct maxgui_proxygadgets_userinput_tUserInput_obj*,BBINT);
typedef BBOBJECT (*maxgui_proxygadgets_userinput_tUserInput_eventHandler_TObject_iTObjectTObject_f)(BBINT,BBOBJECT,BBOBJECT);
BBOBJECT maxgui_proxygadgets_userinput_tUserInput_eventHandler_TObject_iTObjectTObject(BBINT,BBOBJECT,BBOBJECT);
struct BBClass_maxgui_proxygadgets_userinput_tUserInput {
	...
	maxgui_proxygadgets_userinput_tUserInput_CleanUp_m m_CleanUp;
	...
	maxgui_proxygadgets_userinput_tUserInput_SetText_S_m m_SetText_S;
	maxgui_maxgui_gadget_TProxyGadget_GetText_m m_GetText;
	maxgui_proxygadgets_userinput_tUserInput_SetFont_TTGuiFont_m m_SetFont_TTGuiFont;
	maxgui_proxygadgets_userinput_tUserInput_SetColor_iii_m m_SetColor_iii;
	...
	maxgui_proxygadgets_userinput_tUserInput_SetEnabled_i_m m_SetEnabled_i;
	...
	maxgui_proxygadgets_userinput_tUserInput_Class_m m_Class;
	...
	maxgui_proxygadgets_userinput_tUserInput_Create_TtUserInput_SSiiTTGadgetaS_f f_Create_TtUserInput_SSiiTTGadgetaS;
	maxgui_proxygadgets_userinput_tUserInput_eventHandler_TObject_iTObjectTObject_f f_eventHandler_TObject_iTObjectTObject;
};

struct maxgui_proxygadgets_userinput_tUserInput_obj {
	struct BBClass_maxgui_proxygadgets_userinput_tUserInput* clas;
	...
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_userinput_tuserinput_panel;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_userinput_tuserinput_label;
	BBARRAY _maxgui_proxygadgets_userinput_tuserinput_txt;
	BBARRAY _maxgui_proxygadgets_userinput_tuserinput_lbl;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_userinput_tuserinput_btn_ok;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_userinput_tuserinput_btn_cancel;
	BBINT _maxgui_proxygadgets_userinput_tuserinput__window;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_userinput_tuserinput_window;
};
extern struct BBClass_maxgui_proxygadgets_userinput_tUserInput maxgui_proxygadgets_userinput_tUserInput;
