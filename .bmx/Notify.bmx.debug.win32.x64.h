#ifndef MAXGUI_PROXYGADGETS_NOTIFY_BMX_DEBUG_WIN32_X64_H
#define MAXGUI_PROXYGADGETS_NOTIFY_BMX_DEBUG_WIN32_X64_H
...
extern BBINT maxgui_proxygadgets_notify_EVENT_NOTIFY_COMPLETED;
void _maxgui_proxygadgets_notify_Tnotifygadget_New(struct maxgui_proxygadgets_notify_Tnotifygadget_obj* o);
typedef BBINT (*maxgui_proxygadgets_notify_Tnotifygadget_CleanUp_m)(struct maxgui_proxygadgets_notify_Tnotifygadget_obj*);
BBINT _maxgui_proxygadgets_notify_Tnotifygadget_CleanUp(struct maxgui_proxygadgets_notify_Tnotifygadget_obj*);
typedef BBINT (*maxgui_proxygadgets_notify_Tnotifygadget_Class_m)(struct maxgui_proxygadgets_notify_Tnotifygadget_obj*);
BBINT _maxgui_proxygadgets_notify_Tnotifygadget_Class(struct maxgui_proxygadgets_notify_Tnotifygadget_obj*);
typedef BBSTRING (*maxgui_proxygadgets_notify_Tnotifygadget_GetText_m)(struct maxgui_proxygadgets_notify_Tnotifygadget_obj*);
BBSTRING _maxgui_proxygadgets_notify_Tnotifygadget_GetText(struct maxgui_proxygadgets_notify_Tnotifygadget_obj*);
typedef BBINT (*maxgui_proxygadgets_notify_Tnotifygadget_SetFont_TTGuiFont_m)(struct maxgui_proxygadgets_notify_Tnotifygadget_obj*,struct maxgui_maxgui_guifont_TGuiFont_obj*);
BBINT _maxgui_proxygadgets_notify_Tnotifygadget_SetFont_TTGuiFont(struct maxgui_proxygadgets_notify_Tnotifygadget_obj*,struct maxgui_maxgui_guifont_TGuiFont_obj*);
typedef BBINT (*maxgui_proxygadgets_notify_Tnotifygadget_Create_i_SiTTGadgetTObjectTTGuiFont_f)(BBSTRING,BBINT,struct maxgui_maxgui_gadget_TGadget_obj*,BBOBJECT,struct maxgui_maxgui_guifont_TGuiFont_obj*);
BBINT maxgui_proxygadgets_notify_Tnotifygadget_Create_i_SiTTGadgetTObjectTTGuiFont(BBSTRING,BBINT,struct maxgui_maxgui_gadget_TGadget_obj*,BBOBJECT,struct maxgui_maxgui_guifont_TGuiFont_obj*);
typedef BBOBJECT (*maxgui_proxygadgets_notify_Tnotifygadget_eventHandler_TObject_iTObjectTObject_f)(BBINT,BBOBJECT,BBOBJECT);
BBOBJECT maxgui_proxygadgets_notify_Tnotifygadget_eventHandler_TObject_iTObjectTObject(BBINT,BBOBJECT,BBOBJECT);
struct BBClass_maxgui_proxygadgets_notify_Tnotifygadget {
	...
	maxgui_proxygadgets_notify_Tnotifygadget_CleanUp_m m_CleanUp;
	...
	maxgui_proxygadgets_notify_Tnotifygadget_GetText_m m_GetText;
	maxgui_proxygadgets_notify_Tnotifygadget_SetFont_TTGuiFont_m m_SetFont_TTGuiFont;
	...
	maxgui_proxygadgets_notify_Tnotifygadget_Class_m m_Class;
	...
	maxgui_proxygadgets_notify_Tnotifygadget_Create_i_SiTTGadgetTObjectTTGuiFont_f f_Create_i_SiTTGadgetTObjectTTGuiFont;
	maxgui_proxygadgets_notify_Tnotifygadget_eventHandler_TObject_iTObjectTObject_f f_eventHandler_TObject_iTObjectTObject;
};

struct maxgui_proxygadgets_notify_Tnotifygadget_obj {
	struct BBClass_maxgui_proxygadgets_notify_Tnotifygadget* clas;
	...
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_notify_tnotifygadget_text;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_notify_tnotifygadget_button_ok;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_notify_tnotifygadget_button_cancel;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_notify_tnotifygadget_button_abort;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_notify_tnotifygadget_window;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_notify_tnotifygadget_old_window;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_notify_tnotifygadget_line;
	BBINT _maxgui_proxygadgets_notify_tnotifygadget_style;
	BBINT _maxgui_proxygadgets_notify_tnotifygadget__destroy;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_notify_tnotifygadget_icongadget;
};
extern struct BBClass_maxgui_proxygadgets_notify_Tnotifygadget maxgui_proxygadgets_notify_Tnotifygadget;
