#ifndef MAXGUI_PROXYGADGETS_SPINNER_BMX_RELEASE_WIN32_X64_H
#define MAXGUI_PROXYGADGETS_SPINNER_BMX_RELEASE_WIN32_X64_H
...
typedef BBINT (*maxgui_proxygadgets_spinner_TSpinner_SetProp_i_m)(struct maxgui_proxygadgets_spinner_TSpinner_obj*,BBINT);
BBINT _maxgui_proxygadgets_spinner_TSpinner_SetProp_i(struct maxgui_proxygadgets_spinner_TSpinner_obj*,BBINT);
typedef BBINT (*maxgui_proxygadgets_spinner_TSpinner_Class_m)(struct maxgui_proxygadgets_spinner_TSpinner_obj*);
BBINT _maxgui_proxygadgets_spinner_TSpinner_Class(struct maxgui_proxygadgets_spinner_TSpinner_obj*);
typedef BBINT (*maxgui_proxygadgets_spinner_TSpinner_SetFont_TTGuiFont_m)(struct maxgui_proxygadgets_spinner_TSpinner_obj*,struct maxgui_maxgui_guifont_TGuiFont_obj*);
BBINT _maxgui_proxygadgets_spinner_TSpinner_SetFont_TTGuiFont(struct maxgui_proxygadgets_spinner_TSpinner_obj*,struct maxgui_maxgui_guifont_TGuiFont_obj*);
typedef BBINT (*maxgui_proxygadgets_spinner_TSpinner_SetShow_i_m)(struct maxgui_proxygadgets_spinner_TSpinner_obj*,BBINT);
BBINT _maxgui_proxygadgets_spinner_TSpinner_SetShow_i(struct maxgui_proxygadgets_spinner_TSpinner_obj*,BBINT);
typedef BBINT (*maxgui_proxygadgets_spinner_TSpinner_SetRange__ddi_m)(struct maxgui_proxygadgets_spinner_TSpinner_obj*,BBDOUBLE,BBDOUBLE,BBINT);
BBINT _maxgui_proxygadgets_spinner_TSpinner_SetRange__ddi(struct maxgui_proxygadgets_spinner_TSpinner_obj*,BBDOUBLE,BBDOUBLE,BBINT);
typedef BBINT (*maxgui_proxygadgets_spinner_TSpinner_SetColor_iii_m)(struct maxgui_proxygadgets_spinner_TSpinner_obj*,BBINT,BBINT,BBINT);
BBINT _maxgui_proxygadgets_spinner_TSpinner_SetColor_iii(struct maxgui_proxygadgets_spinner_TSpinner_obj*,BBINT,BBINT,BBINT);
typedef BBINT (*maxgui_proxygadgets_spinner_TSpinner_SetEnabled_i_m)(struct maxgui_proxygadgets_spinner_TSpinner_obj*,BBINT);
BBINT _maxgui_proxygadgets_spinner_TSpinner_SetEnabled_i(struct maxgui_proxygadgets_spinner_TSpinner_obj*,BBINT);
typedef BBINT (*maxgui_proxygadgets_spinner_TSpinner_CleanUp_m)(struct maxgui_proxygadgets_spinner_TSpinner_obj*);
BBINT _maxgui_proxygadgets_spinner_TSpinner_CleanUp(struct maxgui_proxygadgets_spinner_TSpinner_obj*);
typedef struct maxgui_proxygadgets_spinner_TSpinner_obj* (*maxgui_proxygadgets_spinner_TSpinner_Create_TTSpinner_iiiiTTGadgeti_f)(BBINT,BBINT,BBINT,BBINT,struct maxgui_maxgui_gadget_TGadget_obj*,BBINT);
struct maxgui_proxygadgets_spinner_TSpinner_obj* maxgui_proxygadgets_spinner_TSpinner_Create_TTSpinner_iiiiTTGadgeti(BBINT,BBINT,BBINT,BBINT,struct maxgui_maxgui_gadget_TGadget_obj*,BBINT);
typedef BBINT (*maxgui_proxygadgets_spinner_TSpinner_SetValue__d_m)(struct maxgui_proxygadgets_spinner_TSpinner_obj*,BBDOUBLE);
BBINT _maxgui_proxygadgets_spinner_TSpinner_SetValue__d(struct maxgui_proxygadgets_spinner_TSpinner_obj*,BBDOUBLE);
typedef BBSTRING (*maxgui_proxygadgets_spinner_TSpinner_GetText_m)(struct maxgui_proxygadgets_spinner_TSpinner_obj*);
BBSTRING _maxgui_proxygadgets_spinner_TSpinner_GetText(struct maxgui_proxygadgets_spinner_TSpinner_obj*);
typedef BBOBJECT (*maxgui_proxygadgets_spinner_TSpinner_EventHook_TObject_iTObjectTObject_f)(BBINT,BBOBJECT,BBOBJECT);
BBOBJECT maxgui_proxygadgets_spinner_TSpinner_EventHook_TObject_iTObjectTObject(BBINT,BBOBJECT,BBOBJECT);
typedef BBINT (*maxgui_proxygadgets_spinner_TSpinner_Round_i_d_f)(BBDOUBLE);
BBINT maxgui_proxygadgets_spinner_TSpinner_Round_i_d(BBDOUBLE);
typedef BBSTRING (*maxgui_proxygadgets_spinner_TSpinner_FloatToString_S_fi_f)(BBFLOAT,BBINT);
BBSTRING maxgui_proxygadgets_spinner_TSpinner_FloatToString_S_fi(BBFLOAT,BBINT);
struct BBClass_maxgui_proxygadgets_spinner_TSpinner {
	...
	maxgui_proxygadgets_spinner_TSpinner_CleanUp_m m_CleanUp;
	...
	maxgui_proxygadgets_spinner_TSpinner_GetText_m m_GetText;
	maxgui_proxygadgets_spinner_TSpinner_SetFont_TTGuiFont_m m_SetFont_TTGuiFont;
	maxgui_proxygadgets_spinner_TSpinner_SetColor_iii_m m_SetColor_iii;
	...
	maxgui_proxygadgets_spinner_TSpinner_SetShow_i_m m_SetShow_i;
	maxgui_proxygadgets_spinner_TSpinner_SetEnabled_i_m m_SetEnabled_i;
	...
	maxgui_proxygadgets_spinner_TSpinner_Class_m m_Class;
	...
	maxgui_proxygadgets_spinner_TSpinner_SetProp_i_m m_SetProp_i;
	...
	maxgui_proxygadgets_spinner_TSpinner_SetRange__ddi_m m_SetRange__ddi;
	maxgui_proxygadgets_spinner_TSpinner_Create_TTSpinner_iiiiTTGadgeti_f f_Create_TTSpinner_iiiiTTGadgeti;
	maxgui_proxygadgets_spinner_TSpinner_SetValue__d_m m_SetValue__d;
	maxgui_proxygadgets_spinner_TSpinner_EventHook_TObject_iTObjectTObject_f f_EventHook_TObject_iTObjectTObject;
	maxgui_proxygadgets_spinner_TSpinner_Round_i_d_f f_Round_i_d;
	maxgui_proxygadgets_spinner_TSpinner_FloatToString_S_fi_f f_FloatToString_S_fi;
};

struct maxgui_proxygadgets_spinner_TSpinner_obj {
	struct BBClass_maxgui_proxygadgets_spinner_TSpinner* clas;
	...
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_spinner_tspinner_panel;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_spinner_tspinner_textfield;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_spinner_tspinner_slider;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_spinner_tspinner_trackbar;
	BBDOUBLE _maxgui_proxygadgets_spinner_tspinner_value;
	BBARRAY _maxgui_proxygadgets_spinner_tspinner_range;
	BBINT _maxgui_proxygadgets_spinner_tspinner_accuracy;
	BBDOUBLE _maxgui_proxygadgets_spinner_tspinner_floatitemmultiplier;
};
extern struct BBClass_maxgui_proxygadgets_spinner_TSpinner maxgui_proxygadgets_spinner_TSpinner;
