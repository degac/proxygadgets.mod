#ifndef MAXGUI_PROXYGADGETS_COLORPICKER_BMX_DEBUG_WIN32_X64_H
#define MAXGUI_PROXYGADGETS_COLORPICKER_BMX_DEBUG_WIN32_X64_H
...
typedef BBINT (*maxgui_proxygadgets_colorpicker_tColorpicker_Class_m)(struct maxgui_proxygadgets_colorpicker_tColorpicker_obj*);
BBINT _maxgui_proxygadgets_colorpicker_tColorpicker_Class(struct maxgui_proxygadgets_colorpicker_tColorpicker_obj*);
typedef BBINT (*maxgui_proxygadgets_colorpicker_tColorpicker_SetFont_TTGuiFont_m)(struct maxgui_proxygadgets_colorpicker_tColorpicker_obj*,struct maxgui_maxgui_guifont_TGuiFont_obj*);
BBINT _maxgui_proxygadgets_colorpicker_tColorpicker_SetFont_TTGuiFont(struct maxgui_proxygadgets_colorpicker_tColorpicker_obj*,struct maxgui_maxgui_guifont_TGuiFont_obj*);
typedef BBINT (*maxgui_proxygadgets_colorpicker_tColorpicker_CleanUp_m)(struct maxgui_proxygadgets_colorpicker_tColorpicker_obj*);
BBINT _maxgui_proxygadgets_colorpicker_tColorpicker_CleanUp(struct maxgui_proxygadgets_colorpicker_tColorpicker_obj*);
typedef BBINT (*maxgui_proxygadgets_colorpicker_tColorpicker_SetShow_i_m)(struct maxgui_proxygadgets_colorpicker_tColorpicker_obj*,BBINT);
BBINT _maxgui_proxygadgets_colorpicker_tColorpicker_SetShow_i(struct maxgui_proxygadgets_colorpicker_tColorpicker_obj*,BBINT);
typedef BBINT (*maxgui_proxygadgets_colorpicker_tColorpicker_SetEnabled_i_m)(struct maxgui_proxygadgets_colorpicker_tColorpicker_obj*,BBINT);
BBINT _maxgui_proxygadgets_colorpicker_tColorpicker_SetEnabled_i(struct maxgui_proxygadgets_colorpicker_tColorpicker_obj*,BBINT);
typedef struct maxgui_proxygadgets_colorpicker_tColorpicker_obj* (*maxgui_proxygadgets_colorpicker_tColorpicker_Create_TtColorpicker_iiiiTTGadgeti_f)(BBINT,BBINT,BBINT,BBINT,struct maxgui_maxgui_gadget_TGadget_obj*,BBINT);
struct maxgui_proxygadgets_colorpicker_tColorpicker_obj* maxgui_proxygadgets_colorpicker_tColorpicker_Create_TtColorpicker_iiiiTTGadgeti(BBINT,BBINT,BBINT,BBINT,struct maxgui_maxgui_gadget_TGadget_obj*,BBINT);
typedef BBINT (*maxgui_proxygadgets_colorpicker_tColorpicker_SetColor_iii_m)(struct maxgui_proxygadgets_colorpicker_tColorpicker_obj*,BBINT,BBINT,BBINT);
BBINT _maxgui_proxygadgets_colorpicker_tColorpicker_SetColor_iii(struct maxgui_proxygadgets_colorpicker_tColorpicker_obj*,BBINT,BBINT,BBINT);
typedef BBSTRING (*maxgui_proxygadgets_colorpicker_tColorpicker_GetText_m)(struct maxgui_proxygadgets_colorpicker_tColorpicker_obj*);
BBSTRING _maxgui_proxygadgets_colorpicker_tColorpicker_GetText(struct maxgui_proxygadgets_colorpicker_tColorpicker_obj*);
typedef BBINT (*maxgui_proxygadgets_colorpicker_tColorpicker_UpdateValue_m)(struct maxgui_proxygadgets_colorpicker_tColorpicker_obj*);
BBINT _maxgui_proxygadgets_colorpicker_tColorpicker_UpdateValue(struct maxgui_proxygadgets_colorpicker_tColorpicker_obj*);
typedef BBINT (*maxgui_proxygadgets_colorpicker_tColorpicker_SetText_S_m)(struct maxgui_proxygadgets_colorpicker_tColorpicker_obj*,BBSTRING);
BBINT _maxgui_proxygadgets_colorpicker_tColorpicker_SetText_S(struct maxgui_proxygadgets_colorpicker_tColorpicker_obj*,BBSTRING);
typedef BBINT (*maxgui_proxygadgets_colorpicker_tColorpicker_SetLayout_iiii_m)(struct maxgui_proxygadgets_colorpicker_tColorpicker_obj*,BBINT,BBINT,BBINT,BBINT);
BBINT _maxgui_proxygadgets_colorpicker_tColorpicker_SetLayout_iiii(struct maxgui_proxygadgets_colorpicker_tColorpicker_obj*,BBINT,BBINT,BBINT,BBINT);
typedef BBOBJECT (*maxgui_proxygadgets_colorpicker_tColorpicker_eventHandler_TObject_iTObjectTObject_f)(BBINT,BBOBJECT,BBOBJECT);
BBOBJECT maxgui_proxygadgets_colorpicker_tColorpicker_eventHandler_TObject_iTObjectTObject(BBINT,BBOBJECT,BBOBJECT);
struct BBClass_maxgui_proxygadgets_colorpicker_tColorpicker {
	...
	maxgui_proxygadgets_colorpicker_tColorpicker_SetLayout_iiii_m m_SetLayout_iiii;
	...
	maxgui_proxygadgets_colorpicker_tColorpicker_CleanUp_m m_CleanUp;
	...
	maxgui_proxygadgets_colorpicker_tColorpicker_SetText_S_m m_SetText_S;
	maxgui_proxygadgets_colorpicker_tColorpicker_GetText_m m_GetText;
	maxgui_proxygadgets_colorpicker_tColorpicker_SetFont_TTGuiFont_m m_SetFont_TTGuiFont;
	maxgui_proxygadgets_colorpicker_tColorpicker_SetColor_iii_m m_SetColor_iii;
	...
	maxgui_proxygadgets_colorpicker_tColorpicker_SetShow_i_m m_SetShow_i;
	maxgui_proxygadgets_colorpicker_tColorpicker_SetEnabled_i_m m_SetEnabled_i;
	...
	maxgui_proxygadgets_colorpicker_tColorpicker_Class_m m_Class;
	...
	maxgui_proxygadgets_colorpicker_tColorpicker_Create_TtColorpicker_iiiiTTGadgeti_f f_Create_TtColorpicker_iiiiTTGadgeti;
	maxgui_proxygadgets_colorpicker_tColorpicker_UpdateValue_m m_UpdateValue;
	maxgui_proxygadgets_colorpicker_tColorpicker_eventHandler_TObject_iTObjectTObject_f f_eventHandler_TObject_iTObjectTObject;
};

struct maxgui_proxygadgets_colorpicker_tColorpicker_obj {
	struct BBClass_maxgui_proxygadgets_colorpicker_tColorpicker* clas;
	...
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_colorpicker_tcolorpicker_panel;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_colorpicker_tcolorpicker_label;
	struct maxgui_maxgui_gadget_TGadget_obj* _maxgui_proxygadgets_colorpicker_tcolorpicker_button;
	BBARRAY _maxgui_proxygadgets_colorpicker_tcolorpicker_rgb;
	BBARRAY _maxgui_proxygadgets_colorpicker_tcolorpicker_spinner;
};
extern struct BBClass_maxgui_proxygadgets_colorpicker_tColorpicker maxgui_proxygadgets_colorpicker_tColorpicker;
